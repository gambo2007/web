...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);
    ...
    <tr class="item">
        ...
        <td>
            <form method="post" action="delete_comment.php" class="mx-auto">
                <div class="form-group">
                    <input id="id_comment" name="id_comment" type="hidden" value=<?= $row['id_comment'] ?>>
                </div>
                <div class="form-group">
                    <button class="btn btn-success px-2">delete comment</button>
                </div>
            </form>
        </td>
    </tr>
    ...
    <p>  File for this classwork: 
        ...
        ?>
    <p>
    <form method="post" action="update_class_work.php" class="rounded w-100 mb-5 mx-auto px-3 pt-3">
      <div class="form-group">
    ...
    <div class="form-group">
        <button class="btn btn-success px-5">Update Classwork</button>
    </div>
</form>
</table>
