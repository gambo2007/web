...
<?php
    ...
    && isset($_POST['user']) && isset($_POST['pass']) && isset($_POST['pass-confirm']) && isset($_POST['birthday'])
    && isset($_POST['PhoneNumber']))
    {
        ...
        if (empty($first_name)) {
            ...
            $result = register($user, $pass, $first_name, $last_name, $email, $birthday, $PhoneNumber);
            if($result['code'] == 0){
        ...
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 border my-5 p-4 rounded mx-3">
                <h3 class="text-center text-secondary mt-2 mb-3 mb-3">Create a new account</h3>
                  ...
                  <form method="post" action="add_account.php" novalidate>
                    <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?= $pass_confirm?>" name="pass-confirm" required class="form-control" type="password" placeholder="Password" id="pass2">
                        <div class="invalid-feedback">Password is not valid.</div>
                    </div>
                    <div class="form-group">
                        <label for="birthday">Birthday</label>
                        <input value="<?= $birthday?>" name="birthday" required class="form-control" type="date" placeholder="Confirm Password" id="birthday">
                        <div class="invalid-feedback">Please enter your birthday.</div>
                    </div>
                    <div class="form-group">
                        <label for="PhoneNumber">PhoneNumber</label>
                        <input value="<?= $PhoneNumber?>" name="PhoneNumber" required class="form-control" type="number" placeholder="PhoneNumber" id="PhoneNumber">
