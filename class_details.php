...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);
    ...
    <tr class="item">
        ...
        <td> | <a href="delete_class.php?id=<?php echo $row["id_work"] ?>" class="delete">Delete</a></td>
    </tr>
	<?php
    if(isset($_POST["class_name"]))
    {
    ...
    {
        $name = $_SESSION['class_name'];
        $_POST["class_name"] = $_SESSION['class_name'];
    }
