...
<?php 
    ...
    $id_student = $_SESSION['id_account'];
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <ul class="navbar-nav">
    ...
    <form method="get" action="Main_s.php" class="form-inline ml-auto">
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <form method="post" action="join_new_class_S.php" class="rounded w-100 mb-5 mx-auto px-3 pt-3">
                            <div class="form-group">
                                <input name="code" id="code" type="text" class="form-control" placeholder="Enter class code">
                            </div>
                            <div class="form-group">
                                <input id="id_student" name="id_student" type="hidden" value= <?= $_SESSION['id_account'] ?> >
                            </div>
                            <div class="form-group">
                                <input id="student_name" name="student_name" type="hidden" value="<?= $_SESSION['name'] ?>">
                            </div>
                            <div class="form-group">
...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);
    ...
    if(isset($_GET['seach_content']))
       $sql = "SELECT * FROM class WHERE id_class IN (SELECT id_class FROM nav WHERE id_student_account='$id_student' AND valid=1) AND class.name LIKE '%".$_GET['seach_content']."%'";
    else
	   $sql = "SELECT * FROM class WHERE id_class IN (SELECT id_class FROM nav WHERE id_student_account='$id_student' AND valid=1)";
    ...
    <tr class="item">
        <td>
            <form method="post" action="class_details_s.php" class="border rounded w-100 mb-5 mx-auto px-3 pt-3 bg-light">
                <div class="form-group">
